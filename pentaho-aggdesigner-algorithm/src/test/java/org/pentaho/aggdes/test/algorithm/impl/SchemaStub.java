...
public class SchemaStub implements Schema {
  ...
  /** Mock implementation of {@link Table} for testing. */
  ...
  /** Mock implementation of {@link Measure} for testing. */
  public static class MeasureStub extends AttributeStub implements Measure {
    public MeasureStub(double space, String colName, String datatype,
        String label, TableStub table) {
  ...
  public static class AttributeStub implements Attribute {
    ...
    public AttributeStub(double space, String colName, String datatype,
        String label, TableStub table) {
      this.space = space;
  ...
  /** Mock implementation of {@link Level} for testing. */
  ...
  /** Mock implementation of {@link Hierarchy} for testing. */
  ...
  /** Mock implementation of {@link Dimension} for testing. */
  ...
  /** Mock implementation of {@link StatisticsProvider} for testing. */
  ...
  protected StatisticsProvider init(List<Attribute> attributes,
