...
/**
 * Utility methods for retrieving and validating the algorithm's command-line
 * arguments.
 */
public class ArgumentUtils {
  ...
  public static Map<Parameter, Object> validateParameters(Component component,
    ...
    for (Map.Entry<String, String> entry : rawParams.entrySet()) {
      ...
      if (parameter == null) {
        throw new ValidationException(component, "Unknown parameter '" + name
      ...
      case INTEGER:
        try {
          ...
          throw new ValidationException(component,
              "Cannot convert parameter '" + name + "' to integer");
        }
        break;
      case DOUBLE:
        try {
          ...
          throw new ValidationException(component,
              "Cannot convert parameter '" + name + "' to double");
        }
        break;
      case BOOLEAN:
    ...
    for (Parameter parameter : parameterList) {
      if (parameter.isRequired() && parameterValues.get(parameter) == null) {
        throw new ValidationException(component,
            "Missing value for required parameter '" + parameter.getName()
